...
<div class='container-fluid'>
	...
	href='messages.php?u_id=$user_id'>
		<img class='img-circle' src='users/$user_image' width='90px' height='80px' title='$user_name'> <strong>&nbsp $first_name $last_name</strong>
	</a>
</div>
";
}
...
echo"<h4 style='color: red; text-align: center;'>Message is too long! use only 50 Characters</h4>";
}else{
