...
$rand = rand(1, 3);
 ...
 if($rand == 1)
$profile_pic = "head1.jpg";
else if ($rand == 2) 
	$profile_pic = "head2.png";
else if ($rand == 3) 
	$profile_pic = "head3.jpg";
...
values('$first_name','$last_name','$username','Hello Xas.This is my default status!','...','$pass','$email','$country','$gender','$birthday','$profile_pic','woods.jpg',NOW(),'$status','$posts','iwanttoputadingintheuniverse.')
";
