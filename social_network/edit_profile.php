	...
	<div class="row">
		...
		<form action="" method="post" enctype="multipart/form-data">
			...
			<tr>
				...
				<td>
				<select class="form-control" type="text" name="Relationship">
			...
			<tr>
				...
				<td>
				<select class="form-control" type="text" name="u_country">
...
<tr>
				...
				<td>
				<select class="form-control" type="text" name="u_gender">
			...
			<tr>
				...
				<td>
				<button class="btn btn-default" type="button" data-toggle="modal" data-target="#myModal">Turn On</button>
