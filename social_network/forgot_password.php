...
<body>
	<div class="row">
		<div class="col-sm-12">
			<div class="well">
				<center><h1 style="color: white"><strong>Xas</strong></h1></center>
			</div>
		</div>
	</div>
	<div class="row">
		...
		<div class="l_pass">
			<form action="" method="post">
				...
				<div class="input-group">
					...
					<input type="text" name="recovery_account" id="msg" placeholder="Someone" required>
				</div><br>
				<a style="text-decoration: none; float: right; color: #187FAB;" data-toggle="tooltip" title="Signin" href="siginin.php">Back to Signin?</a><br><br>
...
if($check_user == 1){
	...
	echo "<script>alert('Your Emial or Bestfriend name is incorrect')</script>";	
}
}
?>